      ...
      <div class="tab-content form-horizontal">
		...
		<div class="tab-pane" id="tab-about">
			<table class="form about">
				...
				<tr>
					<td>Contact</td>
					<td><a href="mailto:support@geekodev.com">other@oc3x.ru</a></td>
				</tr>
				<tr>
					<td>Links</td>
					<td>
						...
						<b>Other modules :</b> <a target="new" href="https://oc3x.ru/extension-opencart">My modules on opencart</a><br/>
					</td>
				</tr>
			</table>
		</div>
