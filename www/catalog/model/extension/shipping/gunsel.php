    ...
    function getQuote($address)
    {
        ...
        if ($status)
        {
            ...
            $quote_data['gunsel'] = array(
                ...
                'text' => $this->currency->format($this->tax->calculate($this->config->get('shipping_gunsel_cost'), $this->config->get('shipping_gunsel_tax_class_id'), $this->config->get('config_tax')), $this->session->data['currency'])
            );
