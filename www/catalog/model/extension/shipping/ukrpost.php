    ...
    function getQuote($address)
    {
        ...
        if ($status)
        {
            ...
            $quote_data['ukrpost'] = array(
                ...
                'text' => $this->currency->format($this->tax->calculate($this->config->get('shipping_ukrpost_cost'), $this->config->get('shipping_ukrpost_tax_class_id'), $this->config->get('config_tax')), $this->session->data['currency'])
            );
