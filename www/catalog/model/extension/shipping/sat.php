    ...
    function getQuote($address)
    {
        ...
        if ($status)
        {
            ...
            $quote_data['sat'] = array(
                ...
                'cost' => $this->config->get('shipping_sat_cost'),
                'tax_class_id' => $this->config->get('shipping_sat_tax_class_id'),
                'text' => $this->currency->format($this->tax->calculate($this->config->get('shipping_sat_cost'), $this->config->get('shipping_sat_tax_class_id'), $this->config->get('config_tax')), $this->session->data['currency'])
            );
