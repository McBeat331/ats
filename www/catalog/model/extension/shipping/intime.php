    ...
    function getQuote($address)
    {
        ...
        if ($status)
        {
            ...
            $quote_data['intime'] = array(
                ...
                'text' => $this->currency->format($this->tax->calculate($this->config->get('shipping_intime_cost'), $this->config->get('shipping_intime_tax_class_id'), $this->config->get('config_tax')), $this->session->data['currency'])
            );
