...
class __TwigTemplate_ee31e7da58fcf1ac42d34161f00ec5a0db758f4d659b73623707d19cc7edd106 extends Twig_Template
{
...
\t";
                            ...
                            // line 29
                            echo "\t</td>
    <td style=\"text-align:right;width: 22%;\"><label for=\"";
                            // line 30
                            echo $this->getAttribute($context["quote"], "code", array());
                            echo "\">";
...
/* 	{% endif %}*/
/* 	</td>*/
/*     <td style="text-align:right;width: 22%;"><label for="{{ quote.code }}">{{ quote.text }}</label></td>*/
/*   </tr>*/
/*   {% endfor %}*/
/*   {% else %}   */
/*   <tr>*/
