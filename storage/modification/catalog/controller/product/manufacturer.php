...
class ControllerProductManufacturer extends Controller {
	...
	public function info() {
		...
		if ($manufacturer_info) {
			...
			$manufacturer_tpl = array();
			$manufacturer_tpl['[name]'] = $manufacturer_info['name'];
			
			
			if ($seogenerator['manufacturer_title']) {
				$this->document->setTitle(trim(strtr($seogenerator['manufacturer_title'], $manufacturer_tpl)));
			} else {
				$this->document->setTitle($manufacturer_info['name']);
			}
			
			
				if ($seogenerator['manufacturer_description']) {
					$this->document->setDescription(trim(strtr($seogenerator['manufacturer_description'], $manufacturer_tpl)));
				} else {
				...
				if ($seogenerator['manufacturer_keywords']) {
					$this->document->setKeywords(trim(strtr($seogenerator['manufacturer_keywords'], $manufacturer_tpl)));
				} else {
					$this->document->setKeywords($manufacturer_info['name']);
				}
			...
			if ($seogenerator['manufacturer_h1']) {
				$data['heading_title'] = (trim(strtr($seogenerator['manufacturer_h1'], $manufacturer_tpl)));
			} else {
